          ...
          <View style={styles.popup}>
            ...
            {selectedEntry >= 0 && (
              <View style={styles.popup}>
                ...
                <Text style={styles.subtitle}>{`${entries[selectedEntry].day} ${entries[selectedEntry].month}, ${entries[selectedEntry].year}`}</Text>
